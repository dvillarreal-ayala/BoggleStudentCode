 ...
 *
 * -> Brought over from TextCompressorStudentCode, intended to be modified for Boggle by Damian V.A.
 *
 * @author Zach Blick
...
public class TST {
    ...
    private class Node {
        Node left, mid, right;
        char c;
        // Should I keep the code as a representation of the space has been visited before?
        int code;
    }
